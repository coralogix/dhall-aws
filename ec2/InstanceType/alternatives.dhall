          ...
          = λ(_params : Parameters.Type) →
            λ(instanceType : InstanceType) →
              merge
                ...
                , r5-large = ./alternatives/r5-large.dhall _params
                , r5-xlarge = ./alternatives/r5-xlarge.dhall _params
                , r5-2xlarge = ./alternatives/r5-2xlarge.dhall _params
                , r5-4xlarge = ./alternatives/r5-4xlarge.dhall _params
                , r5d-large = ./alternatives/r5d-large.dhall _params
                , r5d-xlarge = ./alternatives/r5d-xlarge.dhall _params
                , r5d-2xlarge = ./alternatives/r5d-2xlarge.dhall _params
                , r5d-4xlarge = ./alternatives/r5d-4xlarge.dhall _params
                , r5a-large = ./alternatives/r5a-large.dhall _params
                , r5a-xlarge = ./alternatives/r5a-xlarge.dhall _params
                , r5a-2xlarge = ./alternatives/r5a-2xlarge.dhall _params
                , r5a-4xlarge = ./alternatives/r5a-4xlarge.dhall _params
                , r5ad-large = ./alternatives/r5ad-large.dhall _params
                , r5ad-xlarge = ./alternatives/r5ad-xlarge.dhall _params
                , r5ad-2xlarge = ./alternatives/r5ad-2xlarge.dhall _params
                , r5ad-4xlarge = ./alternatives/r5ad-4xlarge.dhall _params
                ...
                , r5dn-large = ./alternatives/r5dn-large.dhall _params
                , r5dn-xlarge = ./alternatives/r5dn-xlarge.dhall _params
                , r5dn-2xlarge = ./alternatives/r5dn-2xlarge.dhall _params
                , r5dn-4xlarge = ./alternatives/r5dn-4xlarge.dhall _params
