...
let p = Parameters::{ permitLowerClassCPU = True, permitWorseNetwork = True , permitLowerEBSBandwidth = True , permitLosingLocalDisk = True , permitCrossInstanceFamily = True }
